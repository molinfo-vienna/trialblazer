...
def run():
    ...
    ) # create a folder to save temperory files for the test data
    output_path_temp_save_testdata_inactive = "/data/local/Druglikness_prediction/external_test_set/approved_drugs_inactive_target/temp_save" # create a folder to save temperory files for the test data
    ...
    active_preprocessed_target_unique_smiles[
        "target_id"
    ] = active_preprocessed_target_unique_smiles["target_id"].apply(ast.literal_eval) # this step is for converting the string type when I read the file from csv
    inactive_preprocessed_target_unique_smiles[
        "target_id"
    ] = inactive_preprocessed_target_unique_smiles["target_id"].apply(ast.literal_eval) # this step is for converting the string type when I read the file from csv
