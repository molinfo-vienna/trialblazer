...
def SuspectedAdverseDrugEvents_count(
    ...
    benign_not_serious_list_array, benign_serious_list_array = (
        process_adverse_reactions(pre_benign, list_of_adverse_reaction)
    )
    toxic_not_serious_list_array, toxic_serious_list_array = (
        process_adverse_reactions(pre_toxic, list_of_adverse_reaction)
    )
