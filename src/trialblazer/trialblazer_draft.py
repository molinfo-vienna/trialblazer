...
from Preprocess_FoodDB import CheckOutputResult

# these three functions are in folder Dataset_preprocess/Preprocess_compound
from Preprocess_FoodDB import preprocess

# these two functions are in folder Descriptor_calculation
from process_similarity_results import remove_tested_inactive_targets
from process_target_features import add_morgan_fingerprints
from process_target_features import process_target_features
...
h5file_active = "/data/local/Druglikness_prediction/similarity_chembl/WholeInOne/WholeInOne.h5"
